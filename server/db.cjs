...
const initialData = {
  users: [
    ...
    },
    {
      ...
      role: 'student',
      country: 'Kenya 🇰🇪',
      bio: 'High school senior passionate about frontend web development and UI/UX design. Eager to learn React and build real-world applications.',
